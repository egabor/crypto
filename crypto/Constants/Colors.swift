...
extension Color {
    ...
    static let contentGreen = Color("ContentGreen")
    static let divider = Color("Divider")
    static let currencyDetailsContentLoadingOverlay = Color("CurrencyDetailsContentLoadingOverlay")
    static let progressViewTint = Color("ProgressViewTint")
}
